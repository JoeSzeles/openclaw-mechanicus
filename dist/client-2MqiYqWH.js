...
//#endregion
//#region src/gateway/protocol/schema/mesh.ts
const MeshPlanStepSchema = Type.Object({
	id: NonEmptyString,
	name: Type.Optional(NonEmptyString),
...
const MeshWorkflowPlanSchema = Type.Object({
	planId: NonEmptyString,
	goal: NonEmptyString,
	createdAt: Type.Integer({ minimum: 0 }),
	steps: Type.Array(MeshPlanStepSchema, {
		minItems: 1,
		maxItems: 128
	})
}, { additionalProperties: false });
const MeshPlanParamsSchema = Type.Object({
	goal: NonEmptyString,
...
const MeshRunParamsSchema = Type.Object({
	plan: MeshWorkflowPlanSchema,
	continueOnError: Type.Optional(Type.Boolean()),
	maxParallel: Type.Optional(Type.Integer({
		minimum: 1,
		maximum: 16
	})),
	defaultStepTimeoutMs: Type.Optional(Type.Integer({
		minimum: 1e3,
		maximum: 36e5
	})),
	lane: Type.Optional(Type.String())
}, { additionalProperties: false });
const MeshPlanAutoParamsSchema = Type.Object({
	goal: NonEmptyString,
...
const MeshStatusParamsSchema = Type.Object({ runId: NonEmptyString }, { additionalProperties: false });
const MeshRetryParamsSchema = Type.Object({
	runId: NonEmptyString,
...
const validateMeshPlanParams = ajv.compile(MeshPlanParamsSchema);
const validateMeshPlanAutoParams = ajv.compile(MeshPlanAutoParamsSchema);
const validateMeshRunParams = ajv.compile(MeshRunParamsSchema);
const validateMeshStatusParams = ajv.compile(MeshStatusParamsSchema);
const validateMeshRetryParams = ajv.compile(MeshRetryParamsSchema);
...
//#endregion
export { validateNodeInvokeResultParams as $, validateCronStatusParams as A, validateWizardStartParams as At, validateExecApprovalsNodeGetParams as B, deriveDeviceIdFromPublicKey as Bt, validateConfigSetParams as C, validateTalkModeParams as Ct, validateCronRemoveParams as D, validateWebLoginWaitParams as Dt, validateCronListParams as E, validateWebLoginStartParams as Et, validateDeviceTokenRevokeParams as F, SESSION_LABEL_MAX_LENGTH as Ft, validateMeshPlanParams as G, validateExecApprovalsSetParams as H, normalizeDevicePublicKeyBase64Url as Ht, validateDeviceTokenRotateParams as I, parseSessionLabel as It, validateMeshStatusParams as J, validateMeshRetryParams as K, validateExecApprovalRequestParams as L, buildDeviceAuthPayload as Lt, validateDevicePairApproveParams as M, PROTOCOL_VERSION as Mt, validateDevicePairListParams as N, ErrorCodes as Nt, validateCronRunParams as O, validateWizardCancelParams as Ot, validateDevicePairRejectParams as P, errorShape as Pt, validateNodeInvokeParams as Q, validateExecApprovalResolveParams as R, normalizeDeviceAuthScopes as Rt, validateConfigSchemaParams as S, validateTalkConfigParams as St, validateCronAddParams as T, validateWakeParams as Tt, validateLogsTailParams as U, verifyDeviceSignature as Ut, validateExecApprovalsNodeSetParams as V, loadOrCreateDeviceIdentity as Vt, validateMeshPlanAutoParams as W, validateNodeDescribeParams as X, validateModelsListParams as Y, validateNodeEventParams as Z, validateChatInjectParams as _, validateSessionsUsageParams as _t, validateAgentWaitParams as a, validateNodePairVerifyParams as at, validateConfigGetParams as b, validateSkillsStatusParams as bt, validateAgentsFilesGetParams as c, validateRequestFrame as ct, validateAgentsListParams as d, validateSessionsDeleteParams as dt, validateNodeListParams as et, validateAgentsUpdateParams as f, validateSessionsListParams as ft, validateChatHistoryParams as g, validateSessionsResolveParams as gt, validateChatAbortParams as h, validateSessionsResetParams as ht, validateAgentParams as i, validateNodePairRequestParams as it, validateCronUpdateParams as j, validateWizardStatusParams as jt, validateCronRunsParams as k, validateWizardNextParams as kt, validateAgentsFilesListParams as l, validateSendParams as lt, validateChannelsStatusParams as m, validateSessionsPreviewParams as mt, formatValidationErrors as n, validateNodePairListParams as nt, validateAgentsCreateParams as o, validateNodeRenameParams as ot, validateChannelsLogoutParams as p, validateSessionsPatchParams as pt, validateMeshRunParams as q, validateAgentIdentityParams as r, validateNodePairRejectParams as rt, validateAgentsDeleteParams as s, validatePollParams as st, GatewayClient as t, validateNodePairApproveParams as tt, validateAgentsFilesSetParams as u, validateSessionsCompactParams as ut, validateChatSendParams as v, validateSkillsBinsParams as vt, validateConnectParams as w, validateUpdateRunParams as wt, validateConfigPatchParams as x, validateSkillsUpdateParams as xt, validateConfigApplyParams as y, validateSkillsInstallParams as yt, validateExecApprovalsGetParams as z, normalizeFingerprint as zt };