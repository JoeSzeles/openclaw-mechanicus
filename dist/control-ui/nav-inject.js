(function() {
  ...
  nav.id = 'openclaw-nav';
  nav.innerHTML = '<div class="ocn-links"><a href="/">Dashboard</a><a href="/__openclaw__/canvas/">Canvas</a><a href="/model-config.html">Config</a><a href="/workers.html">Workers</a><a href="/processes.html">Processes</a></div>';
