...
import { $ as consumeRestartSentinel, $t as createReplyDispatcher, A as pruneLegacyStoreKeys, An as resolveTtsApiKey, At as loadProviderUsageSummary, Bn as getActiveTaskCount, Bt as buildSafeExternalPrompt, C as resolveAnnounceTargetFromKey, Cn as getAgentRunContext, Ct as requestHeartbeatNow, D as listSessionsFromStore, Dn as getTtsProvider, E as listAgentsForGateway, En as resolveUserTimezone, Et as loadOpenClawPlugins, F as resolveOutboundSessionRoute, Fn as setTtsEnabled, Ft as handleSlackHttpRequest, G as consumeGatewaySigusr1RestartAuthorization, Gn as waitForActiveTasks, Hn as getTotalQueueSize, Ht as getHookType, In as setTtsProvider, It as readJsonBodyWithLimit, J as isGatewaySigusr1RestartExternallyAllowed, K as deferGatewayRestartUntilIdle, Kn as CommandLane, Ln as textToSpeech, Lt as requestBodyErrorToText, M as resolveSessionModelRef, Mn as resolveTtsConfig, Nn as resolveTtsPrefsPath, O as loadCombinedSessionStoreForGateway, On as isTtsEnabled, Ot as normalizeGroupActivation, P as ensureOutboundSessionEntry, Pn as resolveTtsProviderOrder, Q as setPreRestartDeferralCheck, Qn as lookupContextTokens, Qt as dispatchInboundMessage, R as resolveOutboundTarget, Rn as OPENAI_TTS_MODELS, Rt as computeBackoff, S as createOpenClawTools, Sn as emitAgentEvent, St as persistBrowserProxyFiles, Tn as registerAgentRunContext, Tt as getPluginToolMeta, U as runWithModelFallback, Un as resetAllLanes, Ut as isExternalHookSession, V as resetDirectoryCache, Vt as detectSuspiciousPatterns, Wn as setCommandLaneConcurrency, X as scheduleGatewaySigusr1Restart, Y as markGatewaySigusr1RestartHandled, Z as setGatewaySigusr1RestartPolicy, Zn as stripHeartbeatToken, _ as waitForEmbeddedPiRunEnd, _n as runSubagentAnnounceFlow, _t as hasLegacyDeliveryHints, a as getCliSessionId, at as writeRestartSentinel, b as buildDefaultToolPolicyPipelineSteps, cr as DEFAULT_INPUT_IMAGE_MIMES, ct as normalizeCronJobPatch, d as normalizeSendPolicy, dr as extractFileContentFromSource, dt as normalizeOptionalSessionKey, en as getTotalPendingReplies, er as applyModelOverrideToSessionEntry, et as formatDoctorNonInteractiveHint, f as resolveSendPolicy, fr as extractImageContentFromSource, ft as normalizeOptionalText, g as getActiveEmbeddedRunCount, gr as resolveAgentTimeoutMs, gt as buildDeliveryFromLegacyPayload, h as abortEmbeddedPiRun, hn as listDescendantRunsForRequester, ht as migrateLegacyCronPayload, i as resolveCronStyleNow, ir as isSystemEventContextChanged, j as resolveGatewaySessionStoreTarget, jn as resolveTtsAutoMode, k as loadSessionEntry, kn as isTtsProviderConfigured, ln as isAbortTrigger, lr as DEFAULT_INPUT_MAX_REDIRECTS, lt as inferLegacyName, m as runEmbeddedPiAgent, mn as initSubagentRegistry, mr as resolveInputFileLimits, mt as normalizeRequiredName, n as BARE_SESSION_RESET_PROMPT, nr as parseVerboseOverride, o as setCliSessionId, on as formatZonedTimestamp, ot as normalizeHttpWebhookUrl, p as clearSessionQueues, pn as countActiveDescendantRuns, pr as normalizeMimeList, pt as normalizePayloadToSystemText, q as emitGatewayRestart, qn as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, qt as buildHistoryContextFromEntries, rr as enqueueSystemEvent, rt as summarizeRestartSentinel, s as runCliAgent, sr as DEFAULT_INPUT_IMAGE_MAX_BYTES, st as normalizeCronJobCreate, tr as applyVerboseOverride, tt as formatRestartSentinelMessage, un as stopSubagentsForRequester, ur as DEFAULT_INPUT_TIMEOUT_MS, ut as normalizeOptionalAgentId, vn as readLatestAssistantReply, vt as stripLegacyDeliveryFields, w as canonicalizeSpawnedByForAgent, wn as onAgentEvent, xn as clearAgentRunContext, xt as applyBrowserProxyPaths, y as applyToolPolicyPipeline, z as resolveSessionDeliveryTarget, zn as OPENAI_TTS_VOICES, zt as sleepWithAbort } from "./reply-CdswmPvF.js";
...
import { l as registerUnhandledRejectionHandler } from "./runner-DchbsNd6.js";
...
import { g as collectExplicitAllowlist, x as resolveToolProfilePolicy, y as mergeAlsoAllowPolicy } from "./sandbox-DslYImdg.js";
...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-CL_0AHFf.js";
...
import { n as loadModelCatalog } from "./model-catalog-BTBFlq8q.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyText } from "./tokens-sV_zGSb7.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-BS9rKTwQ.js";
import { C as getGlobalHookRunner, T as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-AZBeUz22.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-CMnQ-2uh.js";
import "./manager-DMlMOHzk.js";
import "./sqlite-DWNRhtfU.js";
import "./retry-CsJdgSl0.js";
import { t as ToolInputError } from "./common-C5isiZ_Z.js";
...
import { $ as validateNodeInvokeResultParams, A as validateCronStatusParams, At as validateWizardStartParams, B as validateExecApprovalsNodeGetParams, Bt as deriveDeviceIdFromPublicKey, C as validateConfigSetParams, Ct as validateTalkModeParams, D as validateCronRemoveParams, Dt as validateWebLoginWaitParams, E as validateCronListParams, Et as validateWebLoginStartParams, F as validateDeviceTokenRevokeParams, G as validateMeshPlanParams, H as validateExecApprovalsSetParams, Ht as normalizeDevicePublicKeyBase64Url, I as validateDeviceTokenRotateParams, It as parseSessionLabel, J as validateMeshStatusParams, K as validateMeshRetryParams, L as validateExecApprovalRequestParams, Lt as buildDeviceAuthPayload, M as validateDevicePairApproveParams, Mt as PROTOCOL_VERSION, N as validateDevicePairListParams, Nt as ErrorCodes, O as validateCronRunParams, Ot as validateWizardCancelParams, P as validateDevicePairRejectParams, Pt as errorShape, Q as validateNodeInvokeParams, R as validateExecApprovalResolveParams, Rt as normalizeDeviceAuthScopes, S as validateConfigSchemaParams, St as validateTalkConfigParams, T as validateCronAddParams, Tt as validateWakeParams, U as validateLogsTailParams, Ut as verifyDeviceSignature, V as validateExecApprovalsNodeSetParams, W as validateMeshPlanAutoParams, X as validateNodeDescribeParams, Y as validateModelsListParams, Z as validateNodeEventParams, _ as validateChatInjectParams, _t as validateSessionsUsageParams, a as validateAgentWaitParams, at as validateNodePairVerifyParams, b as validateConfigGetParams, bt as validateSkillsStatusParams, c as validateAgentsFilesGetParams, ct as validateRequestFrame, d as validateAgentsListParams, dt as validateSessionsDeleteParams, et as validateNodeListParams, f as validateAgentsUpdateParams, ft as validateSessionsListParams, g as validateChatHistoryParams, gt as validateSessionsResolveParams, h as validateChatAbortParams, ht as validateSessionsResetParams, i as validateAgentParams, it as validateNodePairRequestParams, j as validateCronUpdateParams, jt as validateWizardStatusParams, k as validateCronRunsParams, kt as validateWizardNextParams, l as validateAgentsFilesListParams, lt as validateSendParams, m as validateChannelsStatusParams, mt as validateSessionsPreviewParams, n as formatValidationErrors, nt as validateNodePairListParams, o as validateAgentsCreateParams, ot as validateNodeRenameParams, p as validateChannelsLogoutParams, pt as validateSessionsPatchParams, q as validateMeshRunParams, r as validateAgentIdentityParams, rt as validateNodePairRejectParams, s as validateAgentsDeleteParams, st as validatePollParams, tt as validateNodePairApproveParams, u as validateAgentsFilesSetParams, ut as validateSessionsCompactParams, v as validateChatSendParams, vt as validateSkillsBinsParams, w as validateConnectParams, wt as validateUpdateRunParams, x as validateConfigPatchParams, xt as validateSkillsUpdateParams, y as validateConfigApplyParams, yt as validateSkillsInstallParams, z as validateExecApprovalsGetParams } from "./client--PPEaq3E.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-BC26-1k1.js";
...
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Bf-7-beo.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-DwIMwMLC.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-BI55Et0V.js";
...
import { t as resolveChannelDefaultAccountId } from "./helpers-BFWp-WKg.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CJCHTT90.js";
...
import "./lifecycle-core-80ZsNO2S.js";
import "./systemd-hints-CTnQqWy3.js";
import { t as parsePort$1 } from "./parse-port-DSdUR1RE.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CpyF0wu4.js";
import "./diagnostics-B26fOlcE.js";
import "./table-BEy-x3L6.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DxlQPsuW.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-wq6vo7tY.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-DoTaufCX.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-B0rWfcG6.js";
import { n as getStatusSummary, r as pickGatewaySelfPresence } from "./status-CLOu8_6R.js";
import { c as startHeartbeatRunner, i as styleHealthChannelLine, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-DD2su2XW.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BHN-URWn.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-DjzbToj-.js";
import { t as runOnboardingWizard } from "./onboarding-BzJ4H2dG.js";
import { a as shouldLogWs, i as logWs, n as parseMessageWithAttachments, o as summarizeAgentEventForWsLog, r as formatForLog, s as setGatewayWsLogStyle, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bolq-xsy.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DWSgCR4z.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-DjTd8vDT.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CjYPR95d.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-Bv0twTar.js";
import "./node-service-Dg_p5CcN.js";
import "./status.update-Hr9bKggv.js";
import { n as validateSystemRunCommandConsistency, t as formatExecCommand } from "./system-run-command-KEvhQEyN.js";
import { t as installSkill } from "./skills-install-BpR3v-Qa.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-BPvl9TmA.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-CG75XZtP.js";
...
const meshRuns = /* @__PURE__ */ new Map();
const MAX_KEEP_RUNS = 200;
const AUTO_PLAN_TIMEOUT_MS = 9e4;
const PLANNER_MAIN_KEY = "mesh-planner";
function trimMap() {
	if (meshRuns.size <= MAX_KEEP_RUNS) return;
	const sorted = [...meshRuns.values()].toSorted((a, b) => a.startedAt - b.startedAt);
	const overflow = meshRuns.size - MAX_KEEP_RUNS;
	for (const stale of sorted.slice(0, overflow)) meshRuns.delete(stale.runId);
}
...
function normalizePlan(plan) {
	return {
		...
		steps: plan.steps.map((step) => ({
			id: step.id.trim(),
			name: typeof step.name === "string" ? step.name.trim() || void 0 : void 0,
			prompt: step.prompt.trim(),
			dependsOn: normalizeDependsOn(step.dependsOn),
			agentId: typeof step.agentId === "string" ? step.agentId.trim() || void 0 : void 0,
			sessionKey: typeof step.sessionKey === "string" ? step.sessionKey.trim() || void 0 : void 0,
			thinking: typeof step.thinking === "string" ? step.thinking : void 0,
			timeoutMs: typeof step.timeoutMs === "number" && Number.isFinite(step.timeoutMs) ? Math.max(1e3, Math.floor(step.timeoutMs)) : void 0
		}))
	};
}
function createPlanFromParams(params) {
	...
	const steps = (params.steps?.length ? params.steps : [{
		id: "step-1",
		name: "Primary Task",
		prompt: goal
	}]).map((step, index) => {
		return {
			...
			name: step.name?.trim() || void 0,
			prompt: step.prompt.trim(),
			dependsOn: normalizeDependsOn(step.dependsOn),
			agentId: step.agentId?.trim() || void 0,
			sessionKey: step.sessionKey?.trim() || void 0,
			thinking: typeof step.thinking === "string" ? step.thinking : void 0,
			timeoutMs: typeof step.timeoutMs === "number" && Number.isFinite(step.timeoutMs) ? Math.max(1e3, Math.floor(step.timeoutMs)) : void 0
		};
	});
...
function validatePlanGraph(plan) {
	...
	for (const step of plan.steps) for (const depId of step.dependsOn ?? []) {
		if (!ids.has(depId)) return {
			ok: false,
			error: `unknown dependency "${depId}" on step "${step.id}"`
		};
		if (depId === step.id) return {
			ok: false,
	...
	if (order.length !== plan.steps.length) return {
		ok: false,
...
function resolveStepTimeoutMs(step, run) {
	if (typeof step.timeoutMs === "number" && Number.isFinite(step.timeoutMs)) return Math.max(1e3, Math.floor(step.timeoutMs));
...
async function executeStep(params) {
	...
	const runId = (() => {
		...
		return typeof candidate?.runId === "string" ? candidate.runId : void 0;
	})();
	...
	step.status = "failed";
	step.endedAt = Date.now();
	step.error = typeof waitPayload?.error === "string" ? waitPayload.error : stringifyUnknown(waited.error ?? `agent.wait returned status ${waitStatus}`);
	run.history.push({
		ts: Date.now(),
		type: "step.error",
		stepId: step.id,
...
function createRunRecord(params) {
	const steps = {};
	for (const step of params.plan.steps) steps[step.id] = {
		id: step.id,
		name: step.name,
		prompt: step.prompt,
...
function findReadySteps(run) {
	...
	for (const stepId of run.stepOrder) {
		...
		if (deps.every((dep) => dep.status === "succeeded")) ready.push(step);
	}
	return ready;
}
async function runWorkflow(run, opts) {
	...
	while (true) {
		if (Object.values(run.steps).some((step) => step.status === "failed") && !run.continueOnError) stopScheduling = true;
		if (!stopScheduling) {
			const ready = findReadySteps(run);
			for (const step of ready) {
				if (inFlight.size >= run.maxParallel) break;
				const task = executeStep({
					run,
					step,
					opts
				}).finally(() => {
	...
	run.status = Object.values(run.steps).some((step) => step.status === "failed") ? "failed" : "completed";
...
function resolveStepIdsForRetry(run, requested) {
	if (Array.isArray(requested) && requested.length > 0) return requested.map((stepId) => stepId.trim()).filter(Boolean);
	return Object.values(run.steps).filter((step) => step.status === "failed" || step.status === "skipped").map((step) => step.id);
}
function descendantsOf(run, roots) {
	...
	while (queue.length > 0) {
		...
		for (const step of Object.values(run.steps)) {
			if (!step.dependsOn.includes(current) || descendants.has(step.id)) continue;
...
function resetStepsForRetry(run, stepIds) {
	...
	for (const stepId of resetIds) {
		const step = run.steps[stepId];
		if (!step) continue;
		if (step.status === "succeeded" && !rootSet.has(stepId)) continue;
		step.status = "pending";
		step.startedAt = void 0;
		step.endedAt = void 0;
		step.error = void 0;
		if (rootSet.has(stepId)) step.agentRunId = void 0;
	}
}
...
function extractTextFromAgentResult(result) {
	...
	const texts = [];
	for (const payload of payloads) if (typeof payload?.text === "string" && payload.text.trim()) texts.push(payload.text.trim());
	return texts.join("\n\n");
}
...
async function generateAutoPlan(params) {
	const prompt = buildAutoPlannerPrompt({
		goal: params.goal,
		maxSteps: params.maxSteps
	});
	const timeoutSeconds = Math.ceil((params.timeoutMs ?? AUTO_PLAN_TIMEOUT_MS) / 1e3);
	...
	try {
		const text = extractTextFromAgentResult(await agentCommand({
			message: prompt,
			deliver: false,
		...
		if (rawSteps.length > 0) return {
			plan: normalizePlan(createPlanFromParams({
				goal: params.goal,
		...
		return {
			plan: normalizePlan(createPlanFromParams({ goal: params.goal })),
			source: "fallback",
			plannerText: text
		};
	} catch {
...
const meshHandlers = {
	"mesh.plan": ({ params, respond }) => {
		if (!validateMeshPlanParams(params)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `invalid mesh.plan params: ${formatValidationErrors(validateMeshPlanParams.errors)}`));
			return;
		}
		const p = params;
		...
		if (!graph.ok) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, graph.error));
			return;
		}
		respond(true, {
			plan,
	...
	"mesh.plan.auto": async ({ params, respond, ...rest }) => {
		if (!validateMeshPlanAutoParams(params)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `invalid mesh.plan.auto params: ${formatValidationErrors(validateMeshPlanAutoParams.errors)}`));
			return;
		}
		const p = params;
		const maxSteps = typeof p.maxSteps === "number" && Number.isFinite(p.maxSteps) ? Math.max(1, Math.min(16, Math.floor(p.maxSteps))) : 6;
	...
	"mesh.run": async (opts) => {
		...
		if (!validateMeshRunParams(params)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `invalid mesh.run params: ${formatValidationErrors(validateMeshRunParams.errors)}`));
			return;
		}
		const p = params;
		...
		const maxParallel = typeof p.maxParallel === "number" && Number.isFinite(p.maxParallel) ? Math.min(16, Math.max(1, Math.floor(p.maxParallel))) : 2;
		const defaultStepTimeoutMs = typeof p.defaultStepTimeoutMs === "number" && Number.isFinite(p.defaultStepTimeoutMs) ? Math.max(1e3, Math.floor(p.defaultStepTimeoutMs)) : 12e4;
		...
		const record = createRunRecord({
			...
			lane: typeof p.lane === "string" ? p.lane : void 0
		});
		meshRuns.set(runId, record);
		trimMap();
		await runWorkflow(record, opts);
		respond(true, summarizeRun(record), void 0);
	},
	"mesh.status": ({ params, respond }) => {
		if (!validateMeshStatusParams(params)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `invalid mesh.status params: ${formatValidationErrors(validateMeshStatusParams.errors)}`));
			return;
		}
		const run = meshRuns.get(params.runId.trim());
		if (!run) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "mesh run not found"));
			return;
		}
		respond(true, summarizeRun(run), void 0);
	},
	"mesh.retry": async (opts) => {
		const { params, respond } = opts;
		if (!validateMeshRetryParams(params)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `invalid mesh.retry params: ${formatValidationErrors(validateMeshRetryParams.errors)}`));
			return;
		}
		...
		if (run.status === "running") {
			respond(false, void 0, errorShape(ErrorCodes.UNAVAILABLE, "mesh run is currently running"));
			return;
		}
		const stepIds = resolveStepIdsForRetry(run, params.stepIds);
		if (stepIds.length === 0) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "no failed or skipped steps available to retry"));
			return;
		}
		for (const stepId of stepIds) if (!run.steps[stepId]) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `unknown retry step id: ${stepId}`));
			return;
		}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BW4Tegd0.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Bf-7-beo.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-AZBeUz22.js").then((n) => n.n);
