...
import { Pt as resolveCommitHash, t as getReplyFromConfig } from "./reply-CdswmPvF.js";
...
import { F as VERSION, I as loadDotEnv, i as loadConfig } from "./config-i7AorPvh.js";
import "./manifest-registry-DoaWeDHN.js";
import { c as installUnhandledRejectionHandler, h as applyTemplate } from "./runner-DchbsNd6.js";
...
import { A as deriveSessionKey, i as loadSessionStore, j as resolveSessionKey, s as saveSessionStore } from "./sessions-B7E6-emA.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-DFwowsBC.js";
import "./outbound-BGINxz8V.js";
import "./session-DAAJzhb4.js";
import "./login-QHcg2TU3.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-DpcVRyu8.js";
import "./catalog-DdTNZaU_.js";
import "./plugin-registry-BH7XvGFp.js";
import { n as resolveCliChannelOptions } from "./channel-options-DNwUfeJJ.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-GYIyRX56.js");
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-BH7XvGFp.js").then((n) => n.n);
