...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-BipDi6tz.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-C5wXDGiT.js";
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-jQwklJz3.js";
import { Gt as formatUsageWindowSummary, Kt as resolveUsageProviderId, Ut as loadProviderUsageSummary, nt as describeFailoverError, s as runEmbeddedPiAgent } from "./subagent-registry-D7Kcs6_x.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CJeHSIux.js";
import { t as ensureOpenClawModelsJson } from "./models-config-D9Ip2qwj.js";
import { n as loadModelCatalog } from "./model-catalog-DYzUm_ve.js";
import { r as withProgressTotals } from "./progress-Clpi3Ckj.js";
import { f as openUrl } from "./onboard-helpers-C223CFn-.js";
...
import { a as isLocalBaseUrl, c as resolveKnownAgentId, d as updateConfig, i as formatTokenK, l as resolveModelKeysFromEntries, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as normalizeAlias, t as applyDefaultModelPrimaryUpdate, u as resolveModelTarget } from "./shared-wRpn8Uwz.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BXxdQVkS.js";
import { n as logConfigUpdated } from "./logging-PVQxLC6I.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-p9nEihEd.js";
...
async function modelsListCommand(opts, runtime) {
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BipDi6tz.js").then((n) => n.t);
