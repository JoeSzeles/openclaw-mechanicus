...
import { At as loadProviderUsageSummary, Mt as formatUsageWindowSummary, Nt as resolveUsageProviderId, W as describeFailoverError, m as runEmbeddedPiAgent } from "./reply-CdswmPvF.js";
...
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-i7AorPvh.js";
import "./manifest-registry-DoaWeDHN.js";
import "./runner-DchbsNd6.js";
import "./image-Bqk8GHw8.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BPPFB5li.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DX1x3UsN.js";
...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-BiTxa1i7.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-XTYLWZaQ.js";
...
import { f as openUrl } from "./onboard-helpers-4IIGckKQ.js";
...
import { t as createClackPrompter } from "./clack-prompter-BV7b_wr-.js";
import { t as renderTable } from "./table-BEy-x3L6.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-B6FHfgGB.js";
import { n as redactSecrets } from "./format-DBqU4ar8.js";
import { a as isLocalBaseUrl, c as resolveKnownAgentId, d as updateConfig, i as formatTokenK, l as resolveModelKeysFromEntries, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as normalizeAlias, t as applyDefaultModelPrimaryUpdate, u as resolveModelTarget } from "./shared-MTiRhHx9.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-ir10egLB.js";
import { n as logConfigUpdated } from "./logging-Cjvw5J7n.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-CLJz1A-p.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-i7AorPvh.js").then((n) => n.t);
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-XTYLWZaQ.js");
