...
import { t as sanitizeContentBlocksImages } from "./tool-images-NOQs9yEy.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DZJ24fjK.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DZJ24fjK.js")).closePlaywrightBrowserConnection();
		} catch {}
