(function() {
  ...
  nav.id = 'openclaw-nav';
  nav.innerHTML = '<div class="ocn-links"><a href="/">Dashboard</a><a href="/__openclaw__/canvas/ig-dashboard.html">IG Trading</a><a href="/__openclaw__/canvas/">Canvas</a><a href="/model-config.html">Config</a><a href="/workers.html">Workers</a><a href="/processes.html">Processes</a></div>';
  ...
  for (var i = 0; i < links.length; i++) {
    ...
    if (href === loc || (href === '/' && (loc === '/index.html' || loc === '/')) || (loc === '/__openclaw__/canvas/ig-dashboard.html' && href === '/__openclaw__/canvas/ig-dashboard.html') || (loc.indexOf('/__openclaw__/canvas') === 0 && href === '/__openclaw__/canvas/' && loc !== '/__openclaw__/canvas/ig-dashboard.html') || (loc === '/model-config.html' && href === '/model-config.html')) {
